...
class CheckoutPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.checkout_item_price = page.locator(
            "[class='cart_item'] [class='inventory_item_price']"
        )
        ...
        self.thank_you_heading = page.get_by_role(
            role="heading", name="Thank you for your order!"
        )
