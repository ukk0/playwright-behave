...
def step_missing_fname_error(context):
    context.page_object.missing_info_warning("Error: First Name is required")

@then("I should see an error about missing last name")
def step_missing_lname_error(context):
    context.page_object.missing_info_warning("Error: Last Name is required")

@then("I should see an error about missing ZIP code")
def step_missing_zip_error(context):
    context.page_object.missing_info_warning("Error: Postal Code is required")
